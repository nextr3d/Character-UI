                        ...
                        if self.path == "":
                            if "visibility" in g:
                                ...
                                try:    
                                    ...
                                    variables.to_list().append({"variable":"var", "data_path":""})
                                g["visibility"]["variables"] = variables
                            else:
                                g["visibility"] = {"expression":"", "variables": [{"variable":"var", "data_path":""}]}
                            ...
                            for att in g["attributes"]:
                                if self.path == att["path"]:
                                    if "visibility" in att:
                                        ...
                                        att["visibility"] = {"expression":"", "variables": [{"variable":"var", "data_path":""}]}
                                    new_var = context.scene.character_ui_variables.add()
                                    new_var.variable = "var"
                                    new_var.data_path = ""
            ...
            if self.panel_name in ch[attributes_key]:
                for g in ch[attributes_key][self.panel_name]:
                    if g["name"] == self.group_name:
                        if self.path == "":
                            if "visibility" in g:
                                context.scene.character_ui_variables.remove(self.var_id)
...
def register():
    for c in classes:
        register_class(c)
    bpy.types.Scene.character_ui_variables = CollectionProperty(type=VisibilityVariableItem)
