    ...
    def execute(self, context):
        if self.character_id:
            text = load_ui_script(context, self.character_id,
                                  self.character_id_key, self.rig_layers_key, self.always_show, self.custom_label)
...
def load_ui_script(context, character_id, character_id_key, rig_layers_key, always_show, custom_label):
